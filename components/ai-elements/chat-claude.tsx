...
const ChatClaude = () => {
    ...
    return (
        <div className="theme-container relative flex h-screen w-full flex-col overflow-hidden bg-transparent font-sans">
                            ...
                            <PromptInputFooter className="p-0">
                                <PromptInputTools>
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="start">
                                            ...
                                            >
                                                <FileIcon className="mr-2" size={16} /> Upload file
                                            </DropdownMenuItem>
                                            <DropdownMenuItem
                                            ...
                                            >
                                                <ScreenShareIcon className="mr-2" size={16} /> Take
                                                screenshot
                                            </DropdownMenuItem>
                                            <DropdownMenuItem
                                                onClick={() => handleFileAction("take-photo")}
                                            >
                                                <CameraIcon className="mr-2" size={16} /> Take photo
                                            </DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
                                    <PromptInputButton variant="outline">
                                ...
                                <div className="flex items-center gap-2">
                                    <PromptInputSelect onValueChange={setModel} value={model}>
                                        <PromptInputSelectTrigger className="font-serif">
                                            <PromptInputSelectValue />
                                        </PromptInputSelectTrigger>
                                        <PromptInputSelectContent className="font-serif">
                                            {models.map((model) => (
