...
export default function CVCard({
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={item}
        className="rounded-xl border border-amber-200 bg-amber-50 p-6 shadow-lg"
      >
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-stone-500">
            {education.graduationYear} • {education.location}
          </p>
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          {onSendMessage && (
            <button
              ...
              className="rounded-full bg-orange-100 px-3 py-1 text-xs font-medium text-orange-600 transition-colors hover:bg-orange-200"
            >
              Ask AI
            </button>
          )}
        </div>
        <CreativeSkillsGraph skills={skills} showAllLabels={true} />
      </motion.div>
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          {onSendMessage && (
            <button
              ...
              className="rounded-full bg-amber-100 px-3 py-1 text-xs font-medium text-amber-600 transition-colors hover:bg-amber-200"
            >
              Show All
            </button>
          )}
