    ...
    <div className="glass rounded-2xl p-6 sm:p-8">
      ...
      <div className="space-y-6">
        <div className="relative pl-6 border-l-2 border-indigo-500/30">
          <div className="absolute -left-[9px] top-0 h-4 w-4 rounded-full border-2 border-indigo-500 bg-zinc-900" />
          ...
          <span className="mt-3 inline-block rounded-full bg-indigo-500/10 px-3 py-1 text-xs font-medium text-indigo-300 border border-indigo-500/10">
            {education.level}
          </span>
        </div>
        ...
        {education.certifications && education.certifications.length > 0 && (
          <div className="pt-4 border-t border-zinc-700/30">
            <h5 className="mb-3 text-sm font-semibold text-zinc-300">
              Certifications
            </h5>
