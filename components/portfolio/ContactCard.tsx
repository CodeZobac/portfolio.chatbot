    ...
    <div className="glass rounded-2xl p-6 sm:p-8">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-sm italic text-zinc-400 border-l-2 border-zinc-700 pl-3">
            "{contact.tagline}"
          </p>
        </div>
        ...
        <div className="space-y-3 pt-4 border-t border-zinc-700/30">
          <div className="flex items-center gap-3 group">
            <div className="p-2 rounded-full bg-zinc-800 group-hover:bg-indigo-500/10 transition-colors">
            ...
            <a href={`mailto:${contact.email}`} className="text-sm text-zinc-300 hover:text-indigo-400 transition-colors">
              {contact.email}
            </a>
          </div>
          ...
          <div className="flex items-center gap-3 group">
            ...
            <a href={`tel:${contact.phone}`} className="text-sm text-zinc-300 hover:text-indigo-400 transition-colors">
              {contact.phone}
            </a>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <a
                ...
                className="flex items-center gap-2 rounded-lg bg-zinc-800/50 px-4 py-2 text-sm font-medium text-zinc-300 transition-all hover:bg-zinc-800 hover:text-indigo-400 border border-transparent hover:border-indigo-500/30"
              >
                {link!.name} →
              </a>
            ))}
