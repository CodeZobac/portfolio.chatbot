...
export const createParticleElement = (x: number, y: number, color: string = DEFAULT_GLOW_COLOR): HTMLDivElement => {
              ...
              return (
                ...
                >
                  <div className="card__header flex justify-between gap-3 relative text-white z-10">
                    <span className="card__label text-xs font-medium uppercase tracking-wider opacity-70">{project.category}</span>
                    {project.featured && (
                  ...
                  <div className="card__content flex flex-col relative text-white z-10 mt-auto">
                    ...
                    <div className="flex flex-wrap gap-1 mt-3 opacity-60">
                      {project.techStack.slice(0, 3).map((tech, i) => (
                        <span key={i} className="text-[10px] px-1.5 py-0.5 rounded bg-white/10">
                          {tech}
                        </span>
                      ))}
                    </div>
