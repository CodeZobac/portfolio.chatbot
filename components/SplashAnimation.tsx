...
// --- WebGL Helper Classes and Functions (Outside component) ---
...
const SplashCursor = memo(
  ({
    ...
    useEffect(() => {
      ...
      if (!glContext || !glContext.gl || !glContext.ext) return;
      ...
      function getWebGLContext(canvas: HTMLCanvasElement) {
        ...
        const halfFloatTexType = isWebGL2
          ...
          : (halfFloat as { HALF_FLOAT_OES: number })?.HALF_FLOAT_OES || 0;
